        ...
        <div
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-medium text-center text-gray-900 dark:text-white mb-2">{{ $title }}
                    </h3>
                    <p class="text-sm text-center text-gray-500 dark:text-gray-400">¿Estás seguro que deseas eliminar
                        <span
                            class="text-lg font-medium text-center text-gray-900 dark:text-white mb-2">{{ $name }}</span>
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 flex flex-col sm:flex-row gap-2 justify-center">
                    ...
                    <button type="button" wire:click="deleteConfirmed"
                        class="w-full sm:w-auto px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
                        Eliminar
                    </button>
                </div>
            </div>
